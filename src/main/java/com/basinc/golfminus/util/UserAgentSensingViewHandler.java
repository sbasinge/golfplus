...
public class UserAgentSensingViewHandler extends ViewHandlerWrapper {
    ...
    public String calculateRenderKitId(FacesContext context) {
    	...
    	log.warn("Calculating renderKit for Url: {} and User Agent: {}",requestUrl,userAgent);
    	if(userAgent.matches(".*(android.+mobile|avantgo|bada\\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\\/|plucker|pocket|psp|symbian|treo|up\\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino).*")
